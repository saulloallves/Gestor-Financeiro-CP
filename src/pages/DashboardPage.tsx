            ...
            <Card key={index} sx={{ 
              ...
              <CardContent>
                <Box sx={{ 
                  ...
                  <Box sx={{
                    backgroundColor: card.color === 'primary.main' ? 'primary.light' :
                                   card.color === 'success.main' ? 'success.light' :
                                   card.color === 'secondary.main' ? 'secondary.light' :
                                   'warning.light',
                    borderRadius: '50%',
                    width: 48,
                    height: 48,
                    ...
                    <IconComponent 
                      size={24} 
                      color={card.color === 'primary.main' ? theme.palette.primary.main :
                             card.color === 'success.main' ? theme.palette.success.main :
                             card.color === 'secondary.main' ? theme.palette.secondary.main :
