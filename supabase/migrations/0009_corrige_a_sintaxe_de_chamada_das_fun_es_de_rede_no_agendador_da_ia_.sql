-- Atualiza a função para usar a sintaxe correta de chamada de função (SELECT func() INTO var)
...
BEGIN
    ...
    LOOP
        BEGIN
            ...
            -- CORREÇÃO: Sintaxe corrigida para chamar uma função que retorna um valor único
            ...
            -- Coleta a resposta da Edge Function
            -- CORREÇÃO: Sintaxe também corrigida aqui
            SELECT net.http_collect_response(request_id) INTO response;

            -- Verifica se a resposta da Edge Function indica um erro
