-- Atualiza a função para usar a chamada mais simples e compatível de http_collect_response
...
BEGIN
    ...
    LOOP
        BEGIN
            ...
            -- CORREÇÃO FINAL: Remove o parâmetro de timeout para usar o padrão do sistema.
            SELECT * INTO response FROM net.http_collect_response(request_id);
