-- Recria a função com a lógica de cálculo de juros e multas corrigida
...
BEGIN
    ...
    LOOP
        ...
        -- A multa é um percentual e deve ser dividida por 100
        v_multa := v_cobranca.valor_original * (v_config.valor_multa_atraso / 100.0);
        
        -- CORREÇÃO: A taxa de juros já está em formato decimal e NÃO deve ser dividida por 100
        v_juros := v_cobranca.valor_original * v_config.taxa_juros_diaria * v_dias_atraso;
        
        -- Aplica o teto máximo para os juros acumulados (que também é um percentual)
