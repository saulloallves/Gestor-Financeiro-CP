-- Melhorias na função de criação de franqueados
-- Atualiza geração de senha e adiciona logging

-- ============================================
-- FUNÇÃO MELHORADA PARA CRIAR FRANQUEADO
-- ============================================
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM franqueados WHERE cpf = p_cpf) THEN
