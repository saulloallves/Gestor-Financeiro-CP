...
BEGIN
    ...
    -- 2. **NOVO PASSO:** Buscar o ID do perfil interno correspondente
    ...
    -- 4. Atualizar a cobrança com o novo status (usando o ID de autenticação para 'updated_by')
    ...
    -- 5. **CORREÇÃO:** Inserir um registro de auditoria usando o ID do perfil interno
    ...
    VALUES (
        ...
        v_old_status,
        p_novo_status,
        v_internal_user_id, -- Usando o ID correto agora
